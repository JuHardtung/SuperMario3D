package parallaxMappingRenderer;
...
public class ParallaxMappingShader extends ShaderProgram{
		
	private static final String VERTEX_FILE = "/parallaxMappingRenderer/parallaxMapVShader.txt";
	private static final String FRAGMENT_FILE = "/parallaxMappingRenderer/parallaxMapFShader.txt";
	...
	protected void loadViewPos(Camera camera) {
