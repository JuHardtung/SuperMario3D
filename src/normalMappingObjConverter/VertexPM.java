...
public class VertexPM {
	...
	private VertexPM duplicateVertex = null;
	private int index;
	private float length;
	private List<Vector3f> tangents = new ArrayList<Vector3f>();
	private Vector3f averagedTangent = new Vector3f(0, 0, 0);
	
	protected VertexPM(int index, Vector3f position){
		this.index = index;
	...
	//NEW
	protected VertexPM duplicate(int newIndex){
		VertexPM vertex = new VertexPM(newIndex, position);
	...
	protected VertexPM getDuplicateVertex() {
		return duplicateVertex;
	}

	protected void setDuplicateVertex(VertexPM duplicateVertex) {
